...
export default function AssigameLogin({ onNavigate }) {
  ...
  return (
    ...
    >
      ...
      {/* Togo map: moved to the left, bottom part of the image cropped off */}
      <div
        style={{
          position: "absolute",
          top: "50%",
      ...
      >
        ...
        >
          ...
          <a href="#" style={{ color: "#e07b1d", textDecoration: "none" }}>
            Mot de passe oublié ?
          </a>
        </div>
