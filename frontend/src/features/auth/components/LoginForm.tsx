  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ fontSize: 30, margin: '0 0 8px', color: '#1a1a1a' }}>Bienvenue</h1>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div style={{ position: 'relative', marginBottom: 18, textAlign: 'left' }}>
            <span style={{ position: 'absolute', left: 16, top: '50%', transform: 'translateY(-50%)', color: '#a9a39a' }}>
              <IconUser />
            </span>
            <input
              id="login-username"
          ...
          >
            ...
            <a href="#" style={{ color: '#F2700B', textDecoration: 'none' }}>
              Mot de passe oublié ?
            </a>
          </div>
        ...
        <div style={{ marginTop: 22, fontFamily: 'Arial, Helvetica, sans-serif', fontSize: 13, color: '#444' }}>
          ...
          <Link href="/register" style={{ color: '#F2700B', textDecoration: 'none', fontWeight: 600 }}>
            S&apos;inscrire
          </Link>
        </div>
      </div>
